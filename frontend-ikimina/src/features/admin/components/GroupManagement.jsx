...
import { useGetAllGroupsQuery, useActivateGroupMutation, useSuspendGroupMutation } from '../adminApi';
      ...
      {showSuspendModal && selectedGroup && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
          <div className="bg-white rounded-lg p-6 max-w-md w-full">
            ...
            <p className="text-gray-600 mb-4">
              Are you sure you want to suspend "{selectedGroup.name}"? This will restrict all group operations.
            </p>
            <textarea
