...
const SubscriptionStatusBanner = ({ subscription }) => {
  ...
  const renderBanner = () => {
    ...
    switch (subscription.status) {
      case 'GRACE_PERIOD':
        return (
          <div className='bg-warning-subtle border-l-4 border-yellow-400 p-4 mb-6'>
            <div className='flex'>
      ...
      case 'SUSPENDED':
        return (
          <div className='bg-danger-subtle border-l-4 border-red-400 p-4 mb-6'>
            <div className='flex'>
              <div className='flex-shrink-0'>
                <FaExclamationTriangle className='h-5 w-5 text-red-400' />
              </div>
              <div className='ml-3'>
                <h3 className='text-sm font-medium text-danger'>Subscription Suspended</h3>
      ...
      case 'ACTIVE':
        if (daysLeft <= 7) {
          return (
            <div className='bg-info-subtle border-l-4 border-blue-400 p-4 mb-6'>
              <div className='flex'>
                <div className='flex-shrink-0'>
                  <FaClock className='h-5 w-5 text-blue-400' />
                </div>
                <div className='ml-3'>
                  <h3 className='text-sm font-medium text-info'>Subscription Renewal Soon</h3>
