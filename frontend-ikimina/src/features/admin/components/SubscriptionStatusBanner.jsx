        ...
        return (
          <div className="bg-yellow-50 border-l-4 border-yellow-400 p-4 mb-6">
            <div className="flex">
              ...
              <div className="ml-3">
                <h3 className="text-sm font-medium text-yellow-800">Payment Overdue - Grace Period Active</h3>
                <div className="mt-2 text-sm text-yellow-700">
                  <p>Your subscription payment is overdue. You have {graceDaysLeft} days left in the grace period.</p>
                  <p className="mt-1">
                    Please make a payment of <strong>${subscription.monthlyPrice} RWF</strong> to avoid service suspension.
                  </p>
            ...
            <div className="flex">
              ...
              <div className="ml-3">
                ...
                <div className="mt-2 text-sm text-red-700">
                  ...
                  <p className="mt-1">Reason: {subscription.suspendedReason || 'Payment not received'}</p>
                  <p className="mt-2">
              ...
              <div className="flex">
                ...
                <div className="ml-3">
                  ...
                  <div className="mt-2 text-sm text-blue-700">
                    ...
                    <p className="mt-1">
                      Next payment: <strong>${subscription.monthlyPrice} RWF</strong> due on {new Date(subscription.endDate).toLocaleDateString()}
                    </p>
                  </div>
                </div>
              </div>
