...
import { useGetAllGroupsQuery, useGetAllUsersQuery, useGetAllSubscriptionsQuery } from '../adminApi';
...
const SuperAdminDashboard = () => {
  ...
  return (
    <div className="space-y-6">
        ...
        <div className="bg-white p-6 rounded-lg shadow">
          <div className="flex items-center">
            ...
            <div className="ml-4">
              ...
              <p className="text-2xl font-semibold text-gray-900">{stats?.totalGroups || 0}</p>
              <p className="text-xs text-gray-500">{stats?.activeGroups || 0} active</p>
            </div>
          </div>
        </div>
        ...
        <div className="bg-white p-6 rounded-lg shadow">
          <div className="flex items-center">
            ...
            <div className="ml-4">
              ...
              <p className="text-2xl font-semibold text-gray-900">{stats?.needsAttention || 0}</p>
              <p className="text-xs text-gray-500">
                {stats?.gracePeriodSubscriptions || 0} grace, {stats?.suspendedSubscriptions || 0} suspended
              </p>
            </div>
          </div>
        </div>
      ...
      <div className="bg-white p-6 rounded-lg shadow">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          ...
          >
            ...
            <p className="text-sm text-gray-500 mt-1">Activate, suspend, or configure groups</p>
          </button>
          ...
          >
            ...
            <p className="text-sm text-gray-500 mt-1">View and manage group subscriptions</p>
          </button>
          ...
          >
            ...
            <p className="text-sm text-gray-500 mt-1">Promote admins or suspend users</p>
          </button>
        </div>
      </div>
      ...
      {/* Recent Activity */}
      <div className="bg-white p-6 rounded-lg shadow">
        <h2 className="text-lg font-medium text-gray-900 mb-4">Recent Subscription Activity</h2>
          ...
          <table className="min-w-full divide-y divide-gray-200">
            ...
            <tbody className="bg-white divide-y divide-gray-200">
              {subscriptions?.slice(0, 5).map((sub) => (
                <tr key={sub.id}>
                  <td className="px-4 py-3 text-sm text-gray-900">{sub.groupName}</td>
                  ...
                  <td className="px-4 py-3 text-sm text-gray-900">{sub.planName}</td>
