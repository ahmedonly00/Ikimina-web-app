...
const DashboardHome = () => {
  ...
  const recentActivities = [
    ...
    { id: 3, user: 'Robert Johnson', action: t('loanRepayment') + ' of $1,200', time: '3 hours ago' },
  ...
  const upcomingPayments = [
    { id: 1, member: 'Alice Johnson', type: t('loanRepayment'), amount: '$350', dueDate: t('tomorrow') },
    { id: 2, member: 'David Wilson', type: t('monthlySavings'), amount: '$200', dueDate: t('in2Days') },
    { id: 3, member: 'Emma Davis', type: t('loanRepayment'), amount: '$450', dueDate: t('in3Days') },
  ];
      ...
      <div className="px-2 sm:px-4 lg:px-8 py-4 sm:py-6 lg:py-8 space-y-4 sm:space-y-6 max-w-full xl:max-w-7xl mx-auto">
                ...
                <div className="flex items-center">
                  <div className="flex-shrink-0">
                    <div className="p-2 sm:p-3 rounded-md bg-indigo-500 bg-opacity-10">
                      <stat.icon className="h-5 w-5 sm:h-6 sm:w-6 text-indigo-600" aria-hidden="true" />
                    </div>
                  </div>
        ...
        <div className="grid grid-cols-1 gap-4 sm:gap-6 lg:grid-cols-1 xl:grid-cols-3">
          ...
          <div className="xl:col-span-2 lg:col-span-1">
            <div className="bg-white shadow overflow-hidden sm:rounded-lg">
              <div className="px-3 sm:px-4 py-3 sm:py-5 border-b border-gray-200">
                <h3 className="text-base sm:text-lg leading-6 font-medium text-gray-900">{t('recentActivity')}</h3>
                <p className="mt-1 max-w-2xl text-xs sm:text-sm text-gray-500">{t('latestActivities')}</p>
              </div>
              ...
              <div className="bg-gray-50 px-3 sm:px-4 py-3 sm:py-4">
                <Link to="/dashboard/loans" className="text-xs sm:text-sm font-medium text-indigo-600 hover:text-indigo-500">
                  {t('viewAll')}
                </Link>
              </div>
            </div>
          ...
          <div>
            <div className="bg-white shadow overflow-hidden sm:rounded-lg">
              <div className="px-3 sm:px-4 py-3 sm:py-5 border-b border-gray-200">
                <h3 className="text-base sm:text-lg leading-6 font-medium text-gray-900">{t('upcomingPayments')}</h3>
                <p className="mt-1 max-w-2xl text-xs sm:text-sm text-gray-500">{t('scheduledPayments')}</p>
              </div>
              <div className="divide-y divide-gray-200">
                  ...
                  <div key={payment.id} className="px-3 sm:px-4 py-3 sm:py-4 hover:bg-gray-50">
                    <div className="flex flex-col sm:flex-row sm:items-start sm:items-center">
                      <div className="flex-1 mb-2 sm:mb-0">
                        <p className="text-xs sm:text-sm font-medium text-gray-900">{payment.member}</p>
                        <p className="text-xs sm:text-sm text-gray-500">{payment.type}</p>
                      </div>
                      <div className="sm:ml-2 flex-shrink-0">
                        <p className="text-xs sm:text-sm font-medium text-gray-900">{payment.amount}</p>
                      </div>
                    </div>
                    <div className="mt-2">
            ...
            <div className="mt-4 sm:mt-6 bg-white shadow overflow-hidden sm:rounded-lg">
              <div className="px-3 sm:px-4 py-3 sm:py-5">
                <h3 className="text-base sm:text-lg leading-6 font-medium text-gray-900">{t('quickActions')}</h3>
              </div>
