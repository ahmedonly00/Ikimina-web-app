        ...
        <div className='mt-6 rounded-md border border-amber-300 bg-amber-50 p-4'>
          ...
          <dl className='mt-3 space-y-1 text-sm'>
            <div className='flex gap-2'>
              ...
              <dd className='font-mono text-amber-900'>{createdAdmin.email}</dd>
            </div>
            <div className='flex gap-2'>
              <dt className='font-medium text-amber-900'>Temporary password:</dt>
              <dd className='font-mono text-amber-900'>{createdAdmin.password}</dd>
            </div>
          </dl>
          <button
            type='button'
                      ...
                      <div className='space-y-4'>
                        ...
                        <div>
                          ...
                          {errors.adminUserEmail && (
                            <p className='mt-1 text-sm text-red-600'>{errors.adminUserEmail}</p>
                          )}
                        </div>
                        <div>
                          <label
