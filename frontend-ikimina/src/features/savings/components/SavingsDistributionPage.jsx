          ...
          <div className="ml-3">
            ...
            <div className="mt-2 text-sm text-blue-700">
              <ul className="list-disc list-inside space-y-1">
                ...
                <li>Only <strong>Ubwizigame</strong> (personal savings) are distributed to members</li>
                <li><strong>Ingoboka</strong> (solidarity fund) remains in the group account</li>
