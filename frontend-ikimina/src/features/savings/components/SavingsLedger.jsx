...
const SavingsLedger = () => {
  ...
  const { data: ledgerData, isLoading, error } = useGetSavingsLedgerQuery({
  ...
  const exportToCSV = () => {
    ...
    const headers = ['No', 'AMAZINA', ...weeks.flatMap(week => [
      `UBWIZIGAME ${week.label}`,
      `INGOBOKA ${week.label}`
    ]), 'MONTHLY TOTAL UBWIZIGAME', 'MONTHLY TOTAL INGOBOKA', 'MONTHLY GRAND TOTAL'];
          ...
          <table className="min-w-full divide-y divide-gray-200">
            <thead className="bg-gray-50">
              <tr>
                ...
                {weeks.map(week => (
                  <React.Fragment key={week.weekNumber}>
                    <th className="px-4 py-3 text-center text-xs font-medium text-gray-500 uppercase tracking-wider">
                      ...
                      <div className="text-xs text-gray-400">{week.startDate} - {week.endDate}</div>
                    </th>
                    <th className="px-4 py-3 text-center text-xs font-medium text-gray-500 uppercase tracking-wider">
                      INGOBOKA
                      <div className="text-xs font-normal">{week.label}</div>
                ...
                <th className="px-4 py-3 text-center text-xs font-medium text-gray-500 uppercase tracking-wider bg-blue-50">
                  MONTHLY<br/>TOTAL UBWIZIGAME
                </th>
                <th className="px-4 py-3 text-center text-xs font-medium text-gray-500 uppercase tracking-wider bg-blue-50">
                  MONTHLY<br/>TOTAL INGOBOKA
                </th>
                <th className="px-4 py-3 text-center text-xs font-medium text-gray-500 uppercase tracking-wider bg-blue-50">
                  MONTHLY<br/>GRAND TOTAL
                </th>
              </tr>
            </thead>
            <tbody className="bg-white divide-y divide-gray-200">
              {isLoading ? (
                ...
                <tr>
                  <td colSpan={3 + weeks.length * 2 + 3} className="px-4 py-8 text-center text-red-600">
                ...
                <tr>
                  <td colSpan={3 + weeks.length * 2 + 3} className="px-4 py-8 text-center text-gray-500">
