...
import { FaCog, FaUser, FaBell, FaLock, FaPalette, FaGlobe, FaSave, FaTimes } from 'react-icons/fa';
    ...
    switch(activeTab) {
        ...
        return (
          <div className="bg-white rounded-lg shadow">
            <div className="px-4 py-5 sm:p-6">
              <h3 className="text-lg leading-6 font-medium text-gray-900 mb-4">{t('generalSettings')}</h3>
      ...
      case 'profile':
        return (
          <div className="bg-white rounded-lg shadow">
            <div className="px-4 py-5 sm:p-6">
              <h3 className="text-lg leading-6 font-medium text-gray-900 mb-4">{t('profileSettings')}</h3>
      ...
      case 'notifications':
        return (
          <div className="bg-white rounded-lg shadow">
            <div className="px-4 py-5 sm:p-6">
              <h3 className="text-lg leading-6 font-medium text-gray-900 mb-4">{t('notificationSettings')}</h3>
              ...
              <div className="space-y-6">
                ...
                <div className="flex items-center justify-between">
                  <div>
                    <label className="text-sm font-medium text-gray-700">{t('pushNotifications')}</label>
                ...
                <div className="flex items-center justify-between">
                  <div>
                    <label className="text-sm font-medium text-gray-700">{t('smsNotifications')}</label>
      ...
      case 'appearance':
        return (
          <div className="bg-white rounded-lg shadow">
            <div className="px-4 py-5 sm:p-6">
              <h3 className="text-lg leading-6 font-medium text-gray-900 mb-4">{t('appearanceSettings')}</h3>
      ...
      case 'language':
        return (
          <div className="bg-white rounded-lg shadow">
            <div className="px-4 py-5 sm:p-6">
              <h3 className="text-lg leading-6 font-medium text-gray-900 mb-4">{t('languageSettings')}</h3>
              ...
              <div className="space-y-6">
                <div>
                  ...
                  <p className="mt-2 text-sm text-gray-500">
                    {languageForm.language === 'en' && 'Select your preferred language for the interface.'}
                    {languageForm.language === 'fr' && 'Sélectionnez votre langue préférée pour l\'interface.'}
              ...
              <nav className="space-y-1">
                <button 
                  ...
                  className={`w-full flex items-center px-4 py-2 text-sm font-medium rounded-md ${
                    activeTab === 'general' ? 'bg-indigo-100 text-indigo-700' : 'text-gray-700 hover:bg-gray-100'
                  }`}
                >
                ...
                <button 
                  ...
                  className={`w-full flex items-center px-4 py-2 text-sm font-medium rounded-md ${
                    activeTab === 'appearance' ? 'bg-indigo-100 text-indigo-700' : 'text-gray-700 hover:bg-gray-100'
                  }`}
                >
                ...
                <button 
                  ...
                  className={`w-full flex items-center px-4 py-2 text-sm font-medium rounded-md ${
                    activeTab === 'language' ? 'bg-indigo-100 text-indigo-700' : 'text-gray-700 hover:bg-gray-100'
                  }`}
                >
